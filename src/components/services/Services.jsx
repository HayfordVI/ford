    ...
    <div className={styles.container}>
      <div className={styles.wrapper}>
        <div className={styles.info}>
          <h1 className={styles.textt}>The Services we offer</h1>
        ...
        <div className={styles.cards}>
          <div className={styles.card}>
            <span className={styles.card_des}>Portraits  </span>
          </div>
          
          <div className={styles.card}>
            <span className={styles.card_des}>Real Estate </span>
          </div>
          <div className={styles.card}>
            <span className={styles.card_des}>Weddings </span>
          </div>
          <div className={styles.card}>
            <span className={styles.card_des}>Corporate</span>
          </div>
          <div className={styles.card}>
            <span className={styles.card_des}>Funeral </span>
          </div>
        </div>
      </div>
    </div>
